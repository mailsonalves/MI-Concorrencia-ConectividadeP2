...
class PassagemModel(Base):
    ...
    # Relacionamentos com UserModel e VooModel
    usuario: Mapped['app.models.user_model.UserModel'] = relationship('app.models.user_model.UserModel', back_populates='passagens_voo')
    voo: Mapped['VooModel'] = relationship('VooModel', back_populates='passagens_voo')